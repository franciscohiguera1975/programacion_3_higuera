...
const areaTriangulo = (base=4, altura = 2) => base * altura/2;

console.log(areaTriangulo(3));     // 9   (3²)
console.log(areaTriangulo(3, 3));  // 27  (3³)
...
const sumarAB   = (a, b) => a + b;
const restar  = (a, b) => a - b;
const multiplicar = (a, b) => a * b;

console.log(operar(10, 3, sumarAB));        // 13
